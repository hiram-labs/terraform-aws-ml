...
output "ml_notebook_job_definition_arn" {
  description = "ARN of the ML Notebook job definition"
  value       = aws_batch_job_definition.ml_notebook_job.arn
}

output "ml_notebook_job_definition_name" {
  description = "Name of the ML Notebook job definition"
  value       = aws_batch_job_definition.ml_notebook_job.name
}
